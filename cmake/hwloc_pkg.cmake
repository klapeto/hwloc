...
function(hwloc_pkg_check_modules variable modules function header)
    ...
    #set(HWLOC_${variable}_CFLAGS "" CACHE STRING "C compiler flags for ${variable}, overriding pkg-config")
    #set(HWLOC_${variable}_LIBS "" CACHE STRING "linker flags for ${variable}, overriding pkg-config")
    ...
    if (${HWLOC_pkg_failed} STREQUAL yes)
        ...
        if (${hwloc_result} STREQUAL 1)
            set(HWLOC_${variable}_CFLAGS ${HWLOC_pkg_cv_HWLOC_${variable}_CFLAGS})
            set(HWLOC_${variable}_LIBS ${HWLOC_pkg_cv_HWLOC_${variable}_LIBS})
            message(CHECK_PASS yes)
